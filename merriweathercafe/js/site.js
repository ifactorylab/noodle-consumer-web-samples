Y.use('node', 'squarespace-ui-base', function() {
  ...
  window.Site = Singleton.create({
    ...
    syncUI: function() {
      ...
      var bFixedHeader = Y.one('body.fixed-header');
      var bTitleOverImage = Y.one('body.title--description-position-over-image');
      ...
      if (Y.one('body.collection-type-index')) {
        ...
        if (this.isMobile) {
          ...
          Y.all('.title-desc-wrapper').setStyle('paddingTop', bFixedHeader ? titlePadding + headerHeight : null)
        ...
        this.parallaxPages.each(function(page,i) {
          ...
          if (!this.isMobile) {
            ...
            if (bTitleOverImage) {
              ...
              if (imageH > this.viewportH) {
                this.parallaxImages.item(i).setStyle('height', imageH + 'px');
              }
            }
    ...
    updateActivePage: function() {
      ...
      if (Y.one('#parallax-nav')) {
        var active = Y.one('#parallax-nav a[href="#'+activePage+'"]');
        // Y.one('#parallax-nav a[href="#'+activePage+'"]').get('parentNode').addClass('active').siblings().removeClass('active');
        if (active) {
          active.get('parentNode').addClass('active').siblings().removeClass('active');
        }
